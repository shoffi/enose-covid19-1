        ...
        if(isConnected) {
            button_off = 
                <button onClick={this.props.setToggleModal} className="p-3 flex bg-red-600 items-center focus:outline-none text-xl">
                    <svg className="w-8 h-8 text-white mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
